    ...
    <div className="relative z-10">
      <section className="px-4 pb-12 pt-24 sm:px-6 sm:pb-16 sm:pt-36">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="order-1 space-y-4 lg:sticky lg:top-28">
          ...
          <div className="order-2 space-y-5 lg:order-1">
            <div className="rounded-[1.35rem] border border-white/10 bg-black/[0.24] p-5 shadow-velvet sm:p-6">
              ...
              <h1 className="mt-4 font-display text-[clamp(2.4rem,8vw,4.4rem)] leading-[0.95] tracking-[-0.02em] text-white">
                Eternal Hope Necklace
              </h1>

              <div className="mt-4 flex flex-wrap items-center gap-3">
                <p className="text-2xl font-extrabold text-gold">{activeFinish.price}</p>
                <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-sm font-semibold text-white/72">
                  Gift box + message card included
                </span>
              </div>
              ...
              <div className="mt-5 grid gap-2 sm:grid-cols-2">
                {quickFacts.map((fact, index) => (
                  <div
                    key={fact}
                    className="inline-flex items-center gap-3 rounded-[1rem] border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-white/82"
                  >
                    <span
                      className={cn(
              ...
              <div className="mt-5 space-y-3">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <p className="text-sm text-gold/80">{activeFinish.label}</p>
                </div>
      ...
      <section className="px-4 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-3">
          <article className="luxury-panel rounded-[1.35rem] p-7">
            <p className="text-sm font-semibold text-gold/80">What you get</p>
            <h2 className="mt-4 font-display text-3xl leading-tight text-white">
              Everything needed for the gift moment.
            </h2>
            <div className="mt-4 grid gap-3 text-sm leading-7 text-foreground/75">
              <p>Necklace with sparkling center stone</p>
              <p>Gift box presentation</p>
              <p>Heartfelt message card already paired</p>
            </div>
          </article>
          <article className="rounded-[1.35rem] border border-white/10 bg-white/[0.045] p-7">
            <p className="text-sm font-semibold text-lavender/80">Size details</p>
            <h2 className="mt-4 font-display text-3xl leading-tight text-white">
              Easy everyday sizing.
            </h2>
            <div className="mt-4 grid gap-3 text-sm leading-7 text-foreground/75">
          ...
          <article className="rounded-[1.35rem] border border-white/10 bg-black/[0.18] p-7">
            <p className="text-sm font-semibold text-gold/80">Best for</p>
            <h2 className="mt-4 font-display text-3xl leading-tight text-white">
              Meaningful gifting.
            </h2>
            <div className="mt-4 grid gap-3 text-sm leading-7 text-foreground/75">
              <p>Parents and grandparents</p>
              <p>Teachers, therapists, and caregivers</p>
              <p>Anyone whose love changed a life</p>
            </div>
          </article>
        </div>
      </section>
      ...
      <section id="who-it-is-for" className="px-4 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-7xl space-y-6">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold text-lavender/80">Who it fits</p>
            <h2 className="mt-3 font-display text-4xl leading-tight text-white sm:text-5xl text-balance">
              Pick the person, then pick the finish.
            </h2>
          </div>
